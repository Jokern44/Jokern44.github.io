...
const supabase = createClient(
  "https://ptowqrfnnwauiiifibnk.supabase.co", // ← Project URL (replace with your own)
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB0b3dxcmZubndhdWlpaWZpYm5rIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQ1Njg0NDQsImV4cCI6MjA4MDE0NDQ0NH0.e396H-bhVon_tge4Txm6dLnBnzBlls-_Spg3TzeD8Ss" // ← anon/public key (rotate if this was a secret)
);
